...
module.exports = {
    siteMetadata: {
        ...
        about: {
            title: '뜨거운 열정보다 중요한 것은 끝까지 견딜수 있는 인내심이다.',
            description1: '뜨거운 열정보다 중요한 것은 끝까지 견딜수 있는 인내심이다라는 말이 있습니다. 저에게 있어서 가슴에 와닿는 말이었으며, 개발자로서는 필수적인 덕목이라고 생각합니다. 저는 끊임없이 노력하고  새로운 기술을 습득하는 것에 관심이 있으며, 웹개발 및 유지보수 경험을 바탕으로 UI/UX 관점을 고려하며 확장 가능한 웹 애플리케이션에 대해 고민하고 있습니다. 저의 다양한 경험과 배경은 창의적 사고를 가능하게 하고 다른 부서와의 소통 능력을 향상할 수 있다고 생각합니다.',
